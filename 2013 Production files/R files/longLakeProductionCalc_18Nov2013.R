...
ELprod=0.06+(0.79*log(ELtaxaBiomass[-c(3,6,8)],10))-(0.16*log(ELmaxBiomass[-c(3,7)]/1000,10))+(0.05*21)
WLprod=0.06+(0.79*log(WLtaxaBiomass[-c(2,6,8)],10))-(0.16*log(WLmaxBiomass[-c(2,7)]/1000,10))+(0.05*21)
ELprod=10^ELprod
WLprod=10^WLprod
